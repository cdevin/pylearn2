...
def explore_train():
    ...
    #Database
    TABLE_NAME = 'nac_train_tfd_group_1'
...
def explore_svm():
    ...
    state.dataset = "tfd"
    state.model_path = "/RQexec/mirzameh/jobs/mirzamom_db/nac_train_tfd_2/"
    state.data_path = DATA_PATH + "faces/TFD/nac_layer1_1024/"
    ...
    state.fold = 0
    state.exp_name = 'tfd_layer2_1024'
