...
def reterive_data(experiment, num, seed):
    db = SQL()
    # get classification results

    valid_query = "select {}_view.id, nunits0, nunits1, nunits2, npieces0, npieces1, npieces2, lrinit, lrdecayfactor,\
            {}keyval.fval from {}_view, {}keyval where {}_view.id = dict_id and seed = {} and\
            name = 'valid_score';".format(experiment,
                    experiment, experiment, experiment, experiment, seed)
...
def main():
    ...
    # report
    results = reterive_data(args.experiment, args.number, args.seed)
