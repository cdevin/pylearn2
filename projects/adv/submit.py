...
def tfd_do(submit = False, make = False):
    state = DD()
    with open('exp/tfd_do.yaml') as ymtmp:
        state.yaml_string = ymtmp.read()
    ...
    for i in xrange(num_exp):
        ...
        state.nvis = rng.randint(50, 2000)
        state.g_dim0 = rng.randint(6000, 12000)
        state.g_dim2 = rng.randint(6000, 12000)
        state.d_dim0 = rng.randint(1000, 5000)
        state.d_dim1 = rng.randint(1000, 5000)
        state.d_pieces0 = rng.randint(2, 5)
        state.d_pieces1 = rng.randint(2, 5)
