...
def experiment(state, channel):
    ...
    valid_result, test_result = fine_tune(
...
def test_experiment():
    ...
    state.dataset = "tfd"
    #state.dataset = "mnist"
    state.model_path = "data/tfd_32_model.pkl"
    state.data_path = DATA_PATH + "TFD/raw/"
    #state.data_path = DATA_PATH + "mnist/"
    state.scale = False
    state.weights = ["data/tfd_32_model.pkl"]
    state.n_ins = 48 * 48
    state.hidden_layers_sizes = [4000]
    state.n_outs = 7
    state.lr = 0.001
    state.batch_size = 1
    state.epochs = 1000
